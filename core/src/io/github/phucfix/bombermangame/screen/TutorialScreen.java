...
public class TutorialScreen implements Screen {
    ...
    public TutorialScreen(BombermanGame game) {
        this.game = game;
        ...
        table.add(new Label("This is tutorial", game.getSkin(), "title")).padBottom(80).row();

        TextButton resumeButton = new TextButton("Go to main menu", game.getSkin());
